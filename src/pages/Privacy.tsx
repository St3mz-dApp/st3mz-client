  ...
  return (
    <div>
      ...
      <p className="pt-1">
        ...
        shared and/or collect in {APP_NAME}. This policy is not applicable to
      ...
      <p className="pt-1">
        ...
        advertising partners of {APP_NAME}.
      </p>
      <p className="pt-1">
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on {APP_NAME}, which are sent
      ...
      <p className="pt-1">
        {APP_NAME} does not knowingly collect any Personal Identifiable
